Config({
  ...
  // نص الشريط الإخباري المتحرك (اكتب هنا الآيات القرآنية أو الإعلانات أو التنبيهات)
  "news-line":
    "        {بسم الله الرحمن الرحيم}( قل للمؤمنين يغضوا من أبصرهم ويحفظوا فروجهم ذلك ازكى لهم إن الله خبير بما يصنعون )صدق الله العضيم   ",
